export const CARDS = {
	ambush: {
		...
		name: 'Ambush',
		text:
			"If eliminated by an opponent's character, discard the attacker and gain 4 influence. If you reveal it yourself, gain 1 influence. Discard Ambush."
	},
	archer: {
		id: 'archer',
		name: 'Archer',
	...
	heir: {
		...
		name: 'Heir',
		text:
			'If there is no other card revealed with the same name, gain 2 influence'
	},
	lord: {
		id: 'lord',
		name: 'Lord',
