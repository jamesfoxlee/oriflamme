...
describe("renders the home page", () => {
  ...
  it("Creates a new Room, plays and discards every card, doesn't target Assassination with Spy", () => {
    ...
    cy.get(".qc-buttons__button-icon").click();
    cy.get(
      ":nth-child(1) > .qc-buttons__prompt > .qc-buttons__buttons > [data-testid=onYes-button] > .qc-buttons__button-icon"
    ).click();
    cy.get("[data-testid=onYes-button] > .qc-buttons__button-icon").click();
    cy.get(
      ":nth-child(1) > .qc-buttons__prompt > .qc-buttons__buttons > [data-testid=onYes-button] > .qc-buttons__button-icon"
    ...
    cy.get(".qc-buttons__button-icon").click();
    cy.get(
      ":nth-child(3) > .qc-buttons__prompt > .qc-buttons__buttons > [data-testid=onYes-button] > .qc-buttons__button-icon"
    ).click();
    cy.get("[data-testid=onYes-button] > .qc-buttons__button-icon").click();
    cy.get(
      ":nth-child(2) > .qc-buttons__prompt > .qc-buttons__buttons > [data-testid=onYes-button] > .qc-buttons__button-icon"
    ).click();
    cy.get(".qc-buttons__button-icon").click();
